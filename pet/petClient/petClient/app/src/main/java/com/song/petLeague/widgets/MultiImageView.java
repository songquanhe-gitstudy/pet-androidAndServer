...
import com.song.petLeague.utils.DensityUtil;
...
public class MultiImageView extends LinearLayout {
	...
	public void setMaxPics(int max) {
		this.MAX_PER_ROW_COUNT = max;
	}

	public int getMaxPics() {

		return this.MAX_PER_ROW_COUNT;
	}
