...
/**
 *
 * @ClassName: PersonCircleActivity
 * @Description: TODO(这里用一句话描述这个类的作用)
 *
 */
public class PersonCircleActivity extends Activity implements CircleContract.View{
    ...
    public static void startPersonCircleActivity(Context context, User user) {
        Intent intetn = new Intent(context, PersonCircleActivity.class);
    ...
    private void initView() {
        ...
        ivBack = (ImageView) findViewById(R.id.iv_back_person_item);
    ...
    private void initData() {
        ...
        mUser = PreUtils.getUserInfo(this);

        tvTitle.setText(user.getName()+"的圈子");
        layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.addItemDecoration(new DivItemDecoration(2, true)); //custom driver
        recyclerView.getMoreProgressView().getLayoutParams().width = ViewGroup.LayoutParams.MATCH_PARENT;

        friendCircleAdapter = new FriendCicleAdapter(this);
            ...
            public void onClick(View v) {
                if (presenter != null) {
                    ...
                    if(TextUtils.isEmpty(content)){
                        Toast.makeText(PersonCircleActivity.this, "评论内容不能为空...", Toast.LENGTH_SHORT).show();
                        return;
                    }
