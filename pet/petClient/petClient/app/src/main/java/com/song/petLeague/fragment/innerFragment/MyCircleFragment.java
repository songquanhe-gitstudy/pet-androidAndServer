...
import com.song.petLeague.activity.EditCircleActivity;
 ...
 *
 */
public class MyCircleFragment extends Fragment implements CircleContract.View{
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        Log.e(TAG, "run: ----下拉刷新");
                        currentPage = 1;
                        circleAdapter.RemoveAll();
                        presenter.loadData(TYPE_PULLREFRESH, currentPage, TYPE_REQUEST, UID);
                    }
                }, 2000);
                //获取用户信息
            }
...
//                    Glide.with(getActivity()).pauseRequests();
            ...
            public void onMoreAsked(int overallItemsCount, int itemsBeforeMore, int maxLastVisiblePosition) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        presenter.loadData(TYPE_UPLOADREFRESH, currentPage, TYPE_REQUEST, UID);
                    }
                }, 2000);
        ...
        actionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String id = PreUtils.getUserInfo(getActivity()).getId();
                Intent intent = new Intent(getActivity(), EditCircleActivity.class);
    ...
    public void update2DeleteCircle(String circleId, final int circlePosition) {
        ...
        circleAdapter.Remove(circlePosition);
