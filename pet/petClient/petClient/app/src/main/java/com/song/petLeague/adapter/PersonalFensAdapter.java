...
import com.song.petLeague.adapter.BaseAdapter.BaseFensRecycleViewAdapter;
...
public class PersonalFensAdapter extends BaseFensRecycleViewAdapter {
    ...
    public PersonalFensAdapter(Context context) {
