...
import com.song.petLeague.utils.StickyExampleModel;
...
public class StickyExampleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    View view = LayoutInflater.from(context).inflate(R.layout.test_layout_list_item, parent, false);
  ...
  public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
    if (viewHolder instanceof RecyclerViewHolder) {
      ...
      recyclerViewHolder.itemView.tvsetContentDescription(stickyExampleModel.sticky);
    }
  }
  ...
  public class RecyclerViewHolder extends RecyclerView.ViewHolder {
    ...
    public RecyclerViewHolder(View itemView) {
      ...
      tvStickyHeader = (TextView) itemView.findViewById(R.id.tv_name_suspend);
