...
import com.song.petLeague.adapter.PersonalFensAdapter;
...
public class PersonalFensActivity extends Activity implements PersonalAttentionContract.View {

    private static final int TYPE_PULLREFRESH = 1;
    private static final int TYPE_UPLOADREFRESH = 2;
    private SuperRecyclerView recyclerView;
    private PersonAttenionPresenter presenter;
    private PersonalFensAdapter personalAdapter;
    ...
    public static void startPersonalFensActivity(Context context, String uId) {
        Intent intent = new Intent(context, PersonalFensActivity.class);
    ...
    private void initData() {
        ...
        personalAdapter = new PersonalFensAdapter(this);
    ...
    private void initListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        presenter.loadFensData(TYPE_PULLREFRESH, currentPage, uId);
                    }
                }, 1000);
            }
        };
        ...
        recyclerView.setupMoreListener(new OnMoreListener() {
            ...
            public void onMoreAsked(int overallItemsCount, int itemsBeforeMore, int maxLastVisiblePosition) {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        currentPage++;
                        presenter.loadFensData(TYPE_UPLOADREFRESH, currentPage, uId);
                    }
                }, 1000);
            }
        }, 1);
        ...
        //点击事件
        personalAdapter.setOnItemClickListener(new PersonalFensAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                List<User> datas = personalAdapter.getDatas();
                User user = datas.get(position);
                Intent intent = new Intent(PersonalFensActivity.this, PersonalDetailsActivity.class);
    ...
    @Override
    public void updata2LoadData(int type, List<User> users) {

    }

    //加载传过来的用户数据
    @Override
    public void updata2LoadFensData(int type, final List<User> userList) {
